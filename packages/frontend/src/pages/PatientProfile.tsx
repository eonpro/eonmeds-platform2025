...
export const PatientProfile: React.FC = () => {
  ...
  const [intakeFormData, setIntakeFormData] = useState<IntakeFormData | null>(
    null,
  );
  ...
  const loadIntakeData = useCallback(async () => {
    ...
    try {
      ...
      if (err?.response?.status === 404) {
        console.log(
          "No webhook data found for patient - this is normal for new patients",
        );
      } else {
    ...
    if (savedNotes) {
      ...
      const cleanedNotes = notes.map((note: TimelineNote) => {
        if (
          ...
          note.content.includes("SOAP Note created -")
        ) {
  ...
  const formatAddress = () => {
    ...
    if (
      (patient.address_house || patient.address_street) &&
      patient.city &&
      patient.state
    ) {
      ...
      if (
        ...
        !addressLine1.toLowerCase().includes("apt")
      ) {
        addressLine1 += `, Apt ${patient.apartment_number}`;
      }
      ...
      const cityInAddress =
        patient.city && addressLower.includes(patient.city.toLowerCase());
      const stateInAddress =
        patient.state && addressLower.includes(patient.state.toLowerCase());
            ...
            <div className="timeline-notes">
              ...
              {timelineNotes
                ...
                .map((note) => (
                  <div
                    key={note.id}
                    className={`timeline-note soap-note-timeline`}
                  >
                    ...
                    <div className="intake-form-note-content">
                      <div className="intake-form-info">
                        <p className="note-title">
                          {patient.patient_id} - Intake Form
                        </p>
              ...
              {timelineNotes
                .filter(
                  (note) =>
                    note.id !== "intake-form" && !note.id.startsWith("soap-"),
                )
                .sort((a, b) => {
                ...
                .map((note) => (
                  <div
                    key={note.id}
                    className={`timeline-note ${note.isPinned ? "pinned" : ""}`}
                  >
                    <div className="note-header">
                      <span className="note-date">
                        {new Date(note.createdAt).toLocaleDateString()}
                ...
                <div className="overview-section">
                  ...
                  <div className="basic-info-section">
                    ...
                    <div className="additional-info">
                      ...
                      <div className="info-item">
                        <label>
                          CLIENT CONSENTS TO DOWNLOAD MEDICATION HISTORY.
                        </label>
                        <p>Yes</p>
                      </div>
                    </div>
                              ...
                              <div className="info-item">
                                ...
                                <p>
                                  ...
                                  >
                                    ...
                                    intakeFormData["I am 18 years or older"] ===
                                      true
                                      ? "✓"
                                      : "✗"}
                                  </span>
                          ...
                          <div className="info-grid">
                            <div className="info-row">
                              <div className="info-item">
                                ...
                                <p>
                                  {intakeFormData.feet || "-"} ft{" "}
                                  {intakeFormData.inches || "-"} in
                                </p>
                              </div>
                              <div className="info-item">
                                <label>WHAT IS YOUR CURRENT WEIGHT?</label>
                                <p>
                                  {intakeFormData.starting_weight ||
                        ...
                        <div className="basic-info-section">
                          ...
                          <div className="info-grid">
                            ...
                            <div className="info-row">
                              <div className="info-item full-width">
                                <label>
                                  ...
                                  MEDICATIONS? IF SO, PLEASE LIST THEM.
                                </label>
                                <p>
                                  {intakeFormData[
                            ...
                            <div className="info-row">
                              <div className="info-item full-width">
                                <label>
                                  DO YOU HAVE ANY ALLERGIES (MEDICATIONS, FOODS,
                                  OR OTHER)?
                                </label>
                                <p>
                                  {intakeFormData[
                        ...
                        <div className="basic-info-section glp1-section">
                          ...
                          <div className="info-grid">
                            <div className="info-row">
                              <div className="info-item full-width">
                                <label>
                                  HAVE YOU PREVIOUSLY TAKEN ANY GLP-1
                                  MEDICATIONS (OZEMPIC, WEGOVY, MOUNJARO, ETC.)?
                                </label>
                                <p>
                                  {intakeFormData[
                              ...
                              <div className="info-item">
                                ...
                                <p>
                                  <span
                                    style={{
                                      color:
                                        intakeFormData.consent_treatment ===
                                          "yes" ||
                                        intakeFormData.consent_treatment ===
                                          true
                                          ? "#14a97b"
                              ...
                              <div className="info-item">
                                ...
                                <p>
                                  <span
                                    style={{
                                      color:
                                        intakeFormData.consent_telehealth ===
                                          "yes" ||
                                        intakeFormData.consent_telehealth ===
                                          true
                                          ? "#14a97b"
                              ...
                              <div className="info-item">
                                ...
                                <p>
                                  <span
                                    style={{
                                      color:
                                        intakeFormData.marketing_consent ===
                                          "yes" ||
                                        intakeFormData.marketing_consent ===
                                          true
                                          ? "#14a97b"
                          ...
                          <div className="info-grid">
                            <div className="info-row">
                              <div className="info-item">
                                ...
                                <p>
                                  {intakeFormData["UTM Source"] ||
                                    intakeFormData.utm_source ||
                                    "-"}
                                </p>
                              </div>
                              <div className="info-item">
                                ...
                                <p>
                                  {intakeFormData["UTM Medium"] ||
                                    intakeFormData.utm_medium ||
                                    "-"}
                                </p>
                              </div>
                              <div className="info-item">
                            ...
                            <div className="info-row">
                              ...
                              <div className="info-item">
                                ...
                                <p>
                                  {intakeFormData["UTM Term"] ||
                                    intakeFormData.utm_term ||
                                    "-"}
                                </p>
                              </div>
                              <div className="info-item">
                                <label>UTM ID</label>
                                <p>
                                  {intakeFormData["UTM ID"] ||
                                    intakeFormData.utm_id ||
                                    "-"}
                                </p>
                              </div>
                            </div>
