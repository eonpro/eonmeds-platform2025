...
export const PatientList: React.FC = () => {
  ...
  const filteredPatients = patients.filter((patient) => {
    ...
    return selectedFilters.some((filter) => {
      ...
      return (
        patient.membership_hashtags?.includes(filterConfig.tag) ||
  ...
  return (
    ...
    >
      <div className="header-section" style={{ marginBottom: '30px' }}>
        <h1 style={{ fontSize: '28px', fontWeight: '600', marginBottom: '20px', color: '#1a1a1a' }}>
          Patients
        </h1>
            ...
            <button
              ...
              style={{
                ...
                backgroundColor: selectedFilters.includes(filter.id)
                  ? `${filter.color}15`
                  : 'white',
                color: selectedFilters.includes(filter.id) ? filter.color : '#6B7280',
                fontSize: '14px',
                fontWeight: '500',
                cursor: 'pointer',
              ...
              {filteredPatients.length === 0 ? (
                ...
                filteredPatients.map((patient) => (
                  ...
                  >
                    ...
                    <td style={{ padding: '16px' }}>{renderPatientStatus(patient)}</td>
                    <td style={{ padding: '16px', fontSize: '14px', color: '#6B7280' }}>
    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
        ...
        {patient.membership_hashtags &&
          patient.membership_hashtags.map((hashtag, index) => (
            <span
              key={index}
              style={{
                padding: '4px 8px',
