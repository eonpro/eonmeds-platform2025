  ...
  const getIcon = () => {
    switch (type) {
      ...
      case 'warning':
        return (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M12 9v4m0 4h.01M5.07 19h13.86c1.66 0 2.64-1.84 1.73-3.26L13.73 4.26c-.87-1.35-2.59-1.35-3.46 0L3.34 15.74C2.43 17.16 3.41 19 5.07 19z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        );
      default:
        return (
