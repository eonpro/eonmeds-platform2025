  ...
  try {
    ...
    for (const webhook of result.rows) {
      ...
      try {
        ...
        console.log(`Creating patient: ${patientData.first_name} ${patientData.last_name} (${patientData.email})`);
        ...
        console.log(`✅ SUCCESS: Created patient ${createdPatient.patient_id} - ${createdPatient.first_name} ${createdPatient.last_name}`);
        successCount++;
