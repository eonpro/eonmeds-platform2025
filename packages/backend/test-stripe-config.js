...
console.log(`✅ STRIPE_SECRET_KEY: ${hasSecretKey ? 'Set (starts with ' + process.env.STRIPE_SECRET_KEY.substring(0, 7) + '...)' : '❌ Not set'}`);
console.log(`✅ STRIPE_WEBHOOK_SECRET: ${hasWebhookSecret ? 'Set (starts with ' + process.env.STRIPE_WEBHOOK_SECRET.substring(0, 7) + '...)' : '❌ Not set'}`);
...
console.log('2. Add REACT_APP_STRIPE_PUBLISHABLE_KEY to packages/frontend/.env');
console.log('3. Run this script again to verify connection');
console.log('4. Set up webhook endpoint in Stripe dashboard or use Stripe CLI for local testing'); 