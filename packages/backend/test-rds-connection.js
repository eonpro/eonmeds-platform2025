...
async function testConnection() {
  try {
    ...
    if (dbCheck.rows.length > 0) {
      ...
      console.log(
        '   You may need to create it or use the default "postgres" database',
      );
    }
    ...
    if (error.code === "ECONNREFUSED") {
      console.error("\n💡 Tips:");
      console.error(
        "1. Make sure you added the RDS configuration to your .env file",
      );
      console.error(
        "2. Check that your IP is allowed in the RDS security group",
      );
