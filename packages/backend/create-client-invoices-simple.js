...
async function createClientInvoices() {
  ...
  try {
    ...
    const clientInvoices = [
      { name: 'Evelyn Zelaya', bmi: 35.2, amount: 229, medication: 'Semaglutide' },
      { name: 'Yerislaydi Gonzalez', bmi: 49.6, amount: 329, medication: 'Tirzepatide' },
      { name: 'Glenda Naranjo', bmi: 33.2, amount: 329, medication: 'Tirzepatide' },
      { name: 'Melida Romero', bmi: 36.6, amount: 329, medication: 'Tirzepatide' },
    ];
