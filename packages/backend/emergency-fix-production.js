...
async function emergencyFix() {
  const connectionString = 'postgresql://eonmeds_admin:398Xakf$57@eonmeds-dev-db.cxy4o6eyy4sq.us-west-2.rds.amazonaws.com:5432/eonmeds?sslmode=disable';
  ...
  try {
    ...
    await client.query('CREATE INDEX idx_invoice_payments_invoice_id ON invoice_payments(invoice_id);');
    await client.query('CREATE INDEX idx_invoice_payments_stripe_payment_intent_id ON invoice_payments(stripe_payment_intent_id);');
