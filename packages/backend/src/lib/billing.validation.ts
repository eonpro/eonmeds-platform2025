...
export const stripeCustomerIdSchema = z.string().regex(/^cus_[a-zA-Z0-9]+$/, 'Invalid Stripe customer ID');
export const stripePriceIdSchema = z.string().regex(/^price_[a-zA-Z0-9]+$/, 'Invalid Stripe price ID');
export const stripeSubscriptionIdSchema = z.string().regex(/^sub_[a-zA-Z0-9]+$/, 'Invalid Stripe subscription ID');
export const stripeInvoiceIdSchema = z.string().regex(/^in_[a-zA-Z0-9]+$/, 'Invalid Stripe invoice ID');
export const stripePaymentIntentIdSchema = z.string().regex(/^pi_[a-zA-Z0-9]+$/, 'Invalid Stripe payment intent ID');
export const stripePaymentMethodIdSchema = z.string().regex(/^pm_[a-zA-Z0-9]+$/, 'Invalid Stripe payment method ID');
...
export const createInvoiceAndPaySchema = z.object({
